...
def run_sweep(workload):
    ...
    run_name = f"Auto_Scalability_4Core_{workload}"
    print(f"\n=== STARTING 4-CORE SCALABILITY RUN: {run_name} ===")
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python auto_wandb.py <WORKLOAD>")
    else:
